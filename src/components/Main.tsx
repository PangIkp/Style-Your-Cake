...
const Main = () => {
  ...
  <span className="absolute backdrop-blur-md rounded-[25px] bg-opacity-50 top-1/2 left-[425px] transform -translate-x-1/2 -translate-y-1/2 bg-white h-[390px] w-[500px] flex flex-col items-left justify-center">
    <span className="text-[25px] font-bold text-white ml-[48px] ">NEW!</span>
    <span className="text-[40px] font-extrabold text-black ml-[48px]">Create your own</span>
    <span className="text-[40px] font-extrabold text-black ml-[48px]">style cake</span>
    <span className="text-[13px] text-[#503C3C] ml-[48px]">Design your dream cake, your way, only at Style Your Cake!</span>
